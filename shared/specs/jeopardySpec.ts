...
export const StartGameAction: Action = { action: "start-game", data: StartGameData }
...
export const AddPointsAction: Action = { action: "add-points", data: AddPointsData }
export const DisplayCategoriesAction: Action = { action: "display-categories", data: NoData }
export const DisplayQuestionAction: Action = { action: "display-question", data: DisplayQuestionData }
export const BuzzAction: Action = { action: "buzz", data: NoData }
export const NextRoundAction: Action = { action: "next-round", data: NoData }
export const ShowSubmissionAction: Action = { action: "show-submission", data: ShowSubmissionData }
export const SubmitAction: Action = { action: "submit", data: SubmitData }
export const GetSubmissionsAction: Action = { action: "get-submissions", data: NoData }
export const QuestionResetAction: Action = { action: "question-reset", data: NoData }
export const ClearBuzzerAction: Action = { action: "clear-buzzer", data: NoData }
export const QuestionNextAction: Action = { action: "question-next", data: NoData }
export const ShowAnswerAction: Action = { action: "show-answer", data: NoData }

export const UpdatePlayersEvent: Message = { event: "update-players", data: PlayersData }
export const UpdateHostEvent: Message = { event: "update-host", data: HostData }
export const ShowCategoriesEvent: Message = { event: "show-categories", data: CategoriesData }
export const ShowQuestionEvent: Message = { event: "show-question", data: QuestionData }
export const SetQuestionStateEvent: Message = { event: "set-question-state", data: QuestionStateData }
export const ToggleSubmissionEvent: Message = { event: "toggle-submission", data: ToggleSubmissionData }
