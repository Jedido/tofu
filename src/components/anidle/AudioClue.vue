<template>
  <div
    class="bg-gray-600 px-2 py-1 w-full ml-auto mr-2 rounded-xl h-12 select-none"
  >
    <div class="flex items-center justify-around">
      <i
        ...
        @click="playAudio"
      ></i>
      <div class="text-amber-50 text-sm mx-2">
      ...
      <input
        ...
        @input="adjustVolume"
      />
      <audio ref="audio" @loadedmetadata="metadataLoaded" @canplay="audioReady">
