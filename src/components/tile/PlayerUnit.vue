<template>
  ...
  >
    <div
      class="absolute top-1/2 left-1/2 grid -translate-x-1/2 -translate-y-1/2 h-8 w-8 z-50"
      @pointerdown="start"
      @contextmenu.prevent=""
    ></div>
    <div
      class="absolute top-1/2 left-1/2 grid -translate-x-1/2 -translate-y-1/2"
    >
      <Block
        :top="top"
        :left="left"
    ...
    <div
      class="w-min arrow select-none absolute flex -top-3 right-0"
      :class="`arrow-${dragDirection}`"
    >
